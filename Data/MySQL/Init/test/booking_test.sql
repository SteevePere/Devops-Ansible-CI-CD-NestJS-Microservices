...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 18, 2020 at 12:52 PM
...
(1, 2, 'room type name', 2),
(2, 2, 'room type name', 2),
(7, 7, 'room type test', 7);
...
(1, 2, 'service type name'),
(2, 2, 'service type name'),
(3, 2, 'service type name'),
(7, 7, 'service type test');
...
INSERT INTO `bookings_bkg` (`BKG_ID`, `USR_ID`, `BKG_START_DATETIME`, `BKG_END_DATETIME`) VALUES
  (2, 19, '2020-03-26', '2020-03-27'),
  (3, 19, '2020-03-26', '2020-03-27');
